...
public class ScanService {
    ...
    public ScanService(OpenFoodFactsApi openFoodFactsApi, StringRedisTemplate redis, ObjectMapper objectMapper, OpenFoodFactToProductConverter openFoodFactToProductConverter) {
